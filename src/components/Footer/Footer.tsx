    ...
    <Box as="footer" sx={{ bg: '#414599', color: 'white', py: 4 }}>
      ...
      >
        <Box sx={{ width: ['100%', '25%'], mb: [3, 0] }}>
          <Text as="h2" sx={{ fontSize: 3, mb: 4 }}>Reach us</Text>
          <Box sx={{ display: 'flex', alignItems: 'center', mb: 4 }}>
            <Link href='https://wa.me/2348035791359' sx={{
              color: 'white', textDecoration: 'none', '&:hover': {
                color: 'lightgreen'
              }
            }}>
        ...
        <Box sx={{ width: ['100%', '15%'], mb: [3, 0] }}>
          <Text as="h2" sx={{ fontSize: 3, mb: 4 }}>Company</Text>
          <Text as={'p'} sx={{ mr: 1, mb: 4 }}><GatsbyLink to='/' style={{ color: '#fff', textDecoration: 'none' }}>Home</GatsbyLink></Text>
          <Text as={'p'} sx={{ mr: 1 }}><GatsbyLink to='/contact' style={{ color: '#fff', textDecoration: 'none' }}>Contact</GatsbyLink></Text>
        </Box>

        <Box sx={{ width: ['100%', '15%'], mb: [3, 0] }}>
          <Text as="h2" sx={{ fontSize: 3, mb: 4 }}>Legal</Text>
          <Text as={'p'} sx={{ mb: 4 }}>Privacy Policy</Text>
          <Text as={'p'} sx={{ mb: 4 }}>Terms & Services</Text>
          <Text as={'p'} sx={{ mb: 4 }}>Terms of Use</Text>
          <Text>Refund Policy</Text>
        </Box>

        <Box sx={{ width: ['100%', '15%'], mb: [3, 0] }}>
          <Text as="h2" sx={{ fontSize: 3, mb: 4 }}>Quick Links</Text>
          <Text as={'p'} sx={{ mb: 4 }}>Techlabz Keybox</Text>
          <Text as={'p'} sx={{ mb: 4 }}>Downloads</Text>
          <Text>Forum</Text>
        </Box>

        <Box sx={{ width: ['100%', '25%'], mb: [3, 0], bg: '#676AAD', p: 3, borderRadius: 4 }}>
          <Text as="h2" sx={{ fontSize: 3, mb: 2 }}>Join Our Newsletter</Text>
